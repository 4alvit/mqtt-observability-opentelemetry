...
This document defines the release policy for **4alvit/mqtt-observability-opentelemetry**. The
...
The committed base version comes from `mqtt-interceptor/pyproject.toml`. A release preparation PR
