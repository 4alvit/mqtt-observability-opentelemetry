...
- `mosquitto-exporter/pyproject.toml`
- `mosquitto-exporter/src/mosquitto_exporter/_version.py`
- `mosquitto-exporter/uv.lock`
- `mqtt-interceptor/pyproject.toml`
- `mqtt-interceptor/src/mqtt_interceptor/_version.py`
- `mqtt-interceptor/uv.lock`
